...
class CustomDimensions extends AbstractFieldArray
{
    ...
    protected function _prepareToRender()
    {
        ...
        $this->addColumn('dimensions_attribute', ['label' => __('Attribute'), 'renderer' => $this->getAttribute()
        ]);
        $this->addColumn('dimensions_index', ['label' => __('Index'), 'renderer' => $this->getIndex()
        ]);
    ...
    {
        $options = [];
        $index = $row->getData('dimensions_index');
    ...
    {
        if (!$this->dimensionsAttribute) {
            $this->dimensionsAttribute = $this->getLayout()->createBlock(
                Attribute::class,
                '',
                ['data' => ['is_render_to_js_template' => true]]
            );
        }
        return $this->dimensionsAttribute;
    }
